...
<div id="container">
	...
	<form action="login_success" method="post" form action="login_success" method="post">
	<div class="login">
		<ul class="form f_l">
			<h1><img src="images/logintitle.gif" alt="会员登录" /></h1>
			
			<span style="color: red; font-weight: 900; text-align: center; " >${ha }</span>
			<li class="login_list"><label>会员名：</label><input type="text" name="login"   />
			   <span id="passMsg"></span>
			</li>
			
			<li class="login_list"><label>密&nbsp;&nbsp;&nbsp;码：</label><input type="password" name="pwd" /><span style="color: red; font-weight: 900;"> ${login_error}</span></li>
		...
		<ul class="aside f_l">
			...
			<li class="a_c"><a href="register.jsp"><img src="images/registernow.gif" alt="现在就注册" /></a></li>
			<ul class="reged">
